    ...
    children: [
      {
        name: 'ticket_account',
        path: '/ticket/account',
        component: 'view.ticket_account',
        meta: {
          title: 'ticket_account',
          i18nKey: 'route.ticket_account'
        }
      },
      {
        name: 'ticket_audit-log',
        path: '/ticket/audit-log',
        component: 'view.ticket_audit-log',
        meta: {
          title: 'ticket_audit-log',
          i18nKey: 'route.ticket_audit-log'
        }
      },
      {
        name: 'ticket_event',
        path: '/ticket/event',
        component: 'view.ticket_event',
        meta: {
          title: 'ticket_event',
          i18nKey: 'route.ticket_event'
        }
      },
      {
      ...
      },
      {
        ...
        meta: {
          title: 'ticket_order-execution',
          i18nKey: 'route.ticket_order-execution'
        }
      },
      {
        name: 'ticket_phone',
        path: '/ticket/phone',
        component: 'view.ticket_phone',
        meta: {
          title: 'ticket_phone',
          i18nKey: 'route.ticket_phone'
        }
      },
      {
        name: 'ticket_platform',
        path: '/ticket/platform',
        component: 'view.ticket_platform',
        meta: {
      ...
      {
        name: 'ticket_sale-task',
        path: '/ticket/sale-task',
        component: 'view.ticket_sale-task',
        meta: {
          title: 'ticket_sale-task',
          i18nKey: 'route.ticket_sale-task'
        }
      }
    ]
  },
