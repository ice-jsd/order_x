...
WHERE `account_id` IN (9300001, 9300002, 9300003, 9300004, 9300005)
   OR `email` IN ('mesh-main-001@jp-ticket-mesh.test', 'live-ready-002@live-pass-jp.test', 'mesh-risk-003@jp-ticket-mesh.test', 'gate-disabled-004@theater-gate.test', 'live-shared-005@live-pass-jp.test');
...
INSERT INTO `ticket_platform_config` (
  ...
  (9100001, '000000', 'jp-ticket-mesh', 'JP Ticket Mesh', 'mock', 'sandbox', 1, 0, 0, 1, 1, 1,
  ...
  (9100002, '000000', 'live-pass-jp', 'Live Pass Japan', 'mock', 'prod', 1, 0, 0, 0, 1, 1,
  ...
  (9100003, '000000', 'theater-gate', 'Theater Gate', 'mock', 'sandbox', 0, 0, 0, 1, 1, 1,
